<template>
    <div ref="el">
        <nodeHeader :title="itemname" nodeType="Reservior" :index="itemindex" sysID="2"/>
      <el-form
        label-width="auto"
      >
        ...
        <div ref="properties">
            ...
            <el-form-item label="Max Cap" label-position="left">
                <el-input v-model="maxcapacity" df-maxcapacity size="small"></el-input>
            </el-form-item>
...
export default defineComponent({
    ...
    setup() {
        ...
        return {
            el, itemname, itemindex, maxcapacity, connections, wearandtear, 
