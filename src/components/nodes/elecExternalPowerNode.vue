<template>
    <div ref="el">
        <nodeHeader :title="itemname" nodeType="ExternalPower" :index="itemindex" sysID="1"/>
      <el-form
        label-width="auto"
      >
        ...
        <div ref="properties">
            ...
            <div v-if="supplierCfg == undefined"> =Supplier Data=
                <el-form-item label="SType" label-position="left" size="small" clearable>
                    <el-select v-model="sType" @change="selectSupplierType" placeholder="Select">
                    <el-option
...
//            wearandtear.value = dataNode.value.data.wearandtear;
        ...
        return {
            el, itemname, itemindex, supplierCfg, sType, vrms, phase, powerrating, powerfactor, frequency, governedrpm, governedrpmratio, referencefrequency, referencerpm, numberofpoles, tensiondroprpm, batterytype, voltage, supplierTypeOptions, batteryTypeOptions, supplierList,
